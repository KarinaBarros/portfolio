...
export default function HeadSobre(){
    return(
        <Head>
        {/* Meta Tags Padrão */}
        <title>Sobre Karina Barros</title>
        ...
        <meta name="keywords" content="desenvolvedora full stack, portfólio, Karina Barros, desenvolvimento web, projetos, programação, frontend, backend, portfolio desenvolvedor, desenvolvedor, programador, dev, portfolio dev" />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${process.env.NEXT_PUBLIC_URL}/sobre`} />
        <meta property="og:title" content='Sobre Karina Barros' />
        ...
        <meta name="twitter:url" content={`${process.env.NEXT_PUBLIC_URL}/sobre`} />
        <meta name="twitter:title" content='Sobre Karina Barros' />
