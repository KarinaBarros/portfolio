export const SEO = {
    ...
    additionalMetaTags: [
      {
        name: 'keywords',
        content: 'desenvolvedora full stack, portfólio, Karina Barros, desenvolvimento web, projetos, programação, frontend, backend, portfolio desenvolvedor, desenvolvedor, programador, dev',
      },
      {
        name: 'author',
